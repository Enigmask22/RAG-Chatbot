...
> Đã hiệu chỉnh Bonferroni cho **30** phép kiểm: α = 0.0016667.
...
| `map@20` | 0.3914 | 0.6144 | +0.2230 | 127 | CI99.83% [+0.1233, +0.3244] · 11↔61 câu khác nhau (p dấu=1.549e-09) · CI95 thô [+0.1607, +0.2864] | khác biệt thật |
| `mrr` | 0.4451 | 0.6573 | +0.2122 | 127 | CI99.83% [+0.1083, +0.3176] · 9↔53 câu khác nhau (p dấu=1.051e-08) · CI95 thô [+0.1471, +0.2780] | khác biệt thật |
| `ndcg@10` | 0.4532 | 0.6604 | +0.2072 | 127 | CI99.83% [+0.1208, +0.2976] · 10↔61 câu khác nhau (p dấu=4.645e-10) · CI95 thô [+0.1523, +0.2631] | khác biệt thật |
| `precision@1` | 0.3307 | 0.5748 | +0.2441 | 127 | p=1.636e-06 · 6↔37 câu đổi chiều | khác biệt thật |
| `precision@10` | 0.0780 | 0.0969 | +0.0189 | 127 | CI99.83% [+0.0087, +0.0307] · 0↔23 câu khác nhau (p dấu=2.384e-07) · CI95 thô [+0.0118, +0.0260] | khác biệt thật |
...
| `precision@5` | 0.1276 | 0.1795 | +0.0520 | 127 | CI99.83% [+0.0268, +0.0787] · 1↔34 câu khác nhau (p dấu=2.095e-09) · CI95 thô [+0.0362, +0.0677] | khác biệt thật |
| `recall@1` | 0.2585 | 0.4738 | +0.2152 | 127 | CI99.83% [+0.0787, +0.3504] · 6↔37 câu khác nhau (p dấu=1.636e-06) · CI95 thô [+0.1299, +0.3005] | khác biệt thật |
| `recall@10` | 0.6050 | 0.7572 | +0.1522 | 127 | CI99.83% [+0.0656, +0.2520] · 0↔23 câu khác nhau (p dấu=2.384e-07) · CI95 thô [+0.0958, +0.2139] | khác biệt thật |
...
| `recall@5` | 0.4948 | 0.7100 | +0.2152 | 127 | CI99.83% [+0.1115, +0.3307] · 1↔34 câu khác nhau (p dấu=2.095e-09) · CI95 thô [+0.1496, +0.2848] | khác biệt thật |
...
| `map@20` | 0.3759 | 0.5907 | +0.2149 | 82 | CI99.83% [+0.0996, +0.3423] · 6↔40 câu khác nhau (p dấu=3.103e-07) · CI95 thô [+0.1405, +0.2936] | khác biệt thật |
| `mrr` | 0.4306 | 0.6234 | +0.1928 | 82 | CI99.83% [+0.0682, +0.3303] · 5↔28 câu khác nhau (p dấu=6.619e-05) · CI95 thô [+0.1135, +0.2764] | khác biệt thật |
| `ndcg@10` | 0.4301 | 0.6291 | +0.1989 | 82 | CI99.83% [+0.0908, +0.3223] · 6↔40 câu khác nhau (p dấu=3.103e-07) · CI95 thô [+0.1286, +0.2744] | khác biệt thật |
| `precision@1` | 0.3537 | 0.5366 | +0.1829 | 82 | p=0.00149 · 3↔18 câu đổi chiều | khác biệt thật |
| `precision@10` | 0.0878 | 0.1073 | +0.0195 | 82 | CI99.83% [+0.0061, +0.0354] · 1↔17 câu khác nhau (p dấu=0.000145) · CI95 thô [+0.0110, +0.0293] | khác biệt thật |
...
| `recall@1` | 0.2398 | 0.4065 | +0.1667 | 82 | CI99.83% [+0.0305, +0.3150] · 3↔18 câu khác nhau (p dấu=0.00149) · CI95 thô [+0.0793, +0.2581] | khác biệt thật |
| `recall@10` | 0.5447 | 0.7012 | +0.1565 | 82 | CI99.83% [+0.0508, +0.2866] · 1↔17 câu khác nhau (p dấu=0.000145) · CI95 thô [+0.0854, +0.2337] | khác biệt thật |
| `recall@20` | 0.5854 | 0.7073 | +0.1220 | 82 | CI99.83% [+0.0264, +0.2419] · 1↔13 câu khác nhau (p dấu=0.001831) · CI95 thô [+0.0589, +0.1931] | khác biệt thật |
| `recall@5` | 0.4492 | 0.6911 | +0.2419 | 82 | CI99.83% [+0.1179, +0.3841] · 0↔26 câu khác nhau (p dấu=2.98e-08) · CI95 thô [+0.1606, +0.3293] | khác biệt thật |
